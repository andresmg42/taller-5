...
### file%3A%2F%2F%2Fhome%2Fandresuv%2FcuartoSemestre%2FPFC%2Fentregables%2Fmatrices%2Fsrc%2Ftest%2Fscala%2Fpruebas.worksheet.sc:251: error: `identifier` expected but `)` found
      sumMatriz(sumMatriz(P5.join, P6.join), restaMatriz(P4.join, P2.)),
                                                                     ^
