...
### file%3A%2F%2F%2Fhome%2Fandresuv%2FcuartoSemestre%2FPFC%2Fentregables%2Fmatrices%2Fsrc%2Ftest%2Fscala%2Fpruebas.worksheet.sc:268: error: `=` expected but `(` found
multStrassen(m1, m2)
            ^
...
def prodPuntoParD(v1:ParVector[Int],v2:ParVector[Int]):
