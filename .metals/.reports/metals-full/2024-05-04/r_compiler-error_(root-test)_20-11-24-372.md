...
### file%3A%2F%2F%2Fhome%2Fandresuv%2FcuartoSemestre%2FPFC%2Fentregables%2Fmatrices%2Fsrc%2Ftest%2Fscala%2Fpruebas.worksheet.sc:567: error: Invalid literal number, followed by identifier character
val mp2 = matrizAlAzar(pow(2, 3S).toInt, 2)
                               ^
...
crearUnaPrueva(mp1,mp2,5,(multMatrizRec,multMatrizRecPar))
```
