...
### file%3A%2F%2F%2Fhome%2Fandresuv%2FcuartoSemestre%2FPFC%2Fentregables%2Fmatrices%2Fsrc%2Ftest%2Fscala%2Fpruebas.worksheet.sc:577: error: `)` expected but `}` found
}
^
...
def crearUnaPrueva(m1:Matriz,m2:Matriz,numeroPruevas:Int,algoritmos:(AlgoritmoMult,AlgoritmoMult))={
  ...
  } yield (compararAlgoritmos(algoritmos._1,algoritmos._2)(m1,m2),pow(2,m1.length)
