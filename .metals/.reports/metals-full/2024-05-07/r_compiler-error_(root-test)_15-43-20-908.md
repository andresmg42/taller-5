...
### file%3A%2F%2F%2Fhome%2Fandresuv%2FcuartoSemestre%2FPFC%2Fentregables%2Fmatrices%2Fsrc%2Ftest%2Fscala%2Fpruebas.worksheet.sc:617: error: illegal start of simple expression
...
def esPrimo(n:Int):Int=if(n%2==0)
```
